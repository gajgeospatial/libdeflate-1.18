...
set_target_properties(libdeflate::libdeflate_static PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/deflatestatic.lib"
  )
...
set_target_properties(libdeflate::libdeflate_shared PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/deflate.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/deflate.dll"
  )
